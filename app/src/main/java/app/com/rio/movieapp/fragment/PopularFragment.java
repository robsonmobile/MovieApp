...
import app.com.rio.movieapp.adapter.MovieAdapter;
...
public class PopularFragment extends BaseFragment {
    ...
    private static final String OBJECT_SORT = "popular";
    ...
    private void setupRecyclerView() {
        ...
        if (startApp) {
            mAdapter = new MovieAdapter(getActivity(), mListMovie);
        }else {
            mAdapter = new MovieAdapter(getActivity(), mListMovieResult);
        }
    ...
    private void getListMovie(final String objectSort) {
        String url = Cons.URL_GET_LIST("popular");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d("GET POPULAR LIST", "Error" + error.getMessage());
            }
        });
